...
hp_flask := 1 ; hp flask position
hp_threshold := 30 ; percentage of life left at which to trigger hp flask
toggle_key := "F10" ; key to toggle autoflask script on/off
hp_toggle_key := "F11" ; key to toggle hp autoflask script on/off
hp_calibrate_key := "F12" ; calibrate the color of hp bar
attack_key := "e" ; key binded to your primary attack
; ----------------------------------------------------
